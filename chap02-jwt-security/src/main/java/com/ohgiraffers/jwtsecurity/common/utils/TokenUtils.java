...
public class TokenUtils {
    ...
    private static Long tokenValidationTime;
    ...
    @Value("${jwt.time}")
    public void  setTokenValidationTime(Long tokenValidationTime) {
        TokenUtils.tokenValidationTime = tokenValidationTime;
    }
    ...
    public static String generateJwtToken(User user) {
        Date expireTime = new Date(System.currentTimeMillis() + tokenValidationTime);
